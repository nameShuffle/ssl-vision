...
static const char qt_meta_stringdata_CaptureFromFile[] = {
    "CaptureFromFile\0"
};
...
const QMetaObjectExtraData CaptureFromFile::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CaptureFromFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CaptureFromFile,
      qt_meta_data_CaptureFromFile, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CaptureFromFile::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CaptureFromFile))
