...
void VarTypes::VarStringEnum::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData VarTypes::VarStringEnum::staticMetaObjectExtraData = {
...
const QMetaObject VarTypes::VarStringEnum::staticMetaObject = {
    { &VarType::staticMetaObject, qt_meta_stringdata_VarTypes__VarStringEnum,
      qt_meta_data_VarTypes__VarStringEnum, &staticMetaObjectExtraData }
};
