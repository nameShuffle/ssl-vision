...
static const char qt_meta_stringdata_VarTypes__VarBool[] = {
    "VarTypes::VarBool\0"
};
...
const QMetaObjectExtraData VarTypes::VarBool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VarTypes::VarBool::staticMetaObject = {
    { &VarTypeTemplate<VarBoolVal>::staticMetaObject, qt_meta_stringdata_VarTypes__VarBool,
      qt_meta_data_VarTypes__VarBool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VarTypes::VarBool::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarBool))
