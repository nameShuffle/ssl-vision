...
void VarTypes::VarDouble::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData VarTypes::VarDouble::staticMetaObjectExtraData = {
...
const QMetaObject VarTypes::VarDouble::staticMetaObject = {
    { &VarTypeTemplate<VarDoubleVal>::staticMetaObject, qt_meta_stringdata_VarTypes__VarDouble,
      qt_meta_data_VarTypes__VarDouble, &staticMetaObjectExtraData }
};
