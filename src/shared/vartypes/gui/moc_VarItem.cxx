...
static const char qt_meta_stringdata_VarTypes__VarItem[] = {
    "VarTypes::VarItem\0\0changeUpdate()\0"
};
...
const QMetaObjectExtraData VarTypes::VarItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VarTypes::VarItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VarTypes__VarItem,
      qt_meta_data_VarTypes__VarItem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VarTypes::VarItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarItem))
