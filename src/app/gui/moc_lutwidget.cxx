...
static const char qt_meta_stringdata_LUTWidget[] = {
    "LUTWidget\0\0c\0selectChannel(int)\0"
};
...
const QMetaObjectExtraData LUTWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LUTWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LUTWidget,
      qt_meta_data_LUTWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LUTWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LUTWidget))
