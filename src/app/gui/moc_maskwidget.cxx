...
static const char qt_meta_stringdata_MaskWidget[] = {
    "MaskWidget\0"
};
...
const QMetaObjectExtraData MaskWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MaskWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MaskWidget,
      qt_meta_data_MaskWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MaskWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MaskWidget))
